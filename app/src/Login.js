...
const handleSubmit=(e)=>{
    ...
    .then(res=>{
      ...
      let message=res.data;
       if(message==="found")  navigate('/home');
  ...
  return (
   <div id="login_form">
    <form id="detail1" onSubmit={handleSubmit} style={{marginLeft:"35%",marginTop:"10px"}}>
      <table>
        <tbody>
      <tr><th>Email:</th><td><input type='email' name='email' value={logindetails.email} onChange={handlechange}/></td></tr>
      <tr><th>password:</th><td><input type='password' name='password' value={logindetails.password} onChange={handlechange}/></td></tr>
